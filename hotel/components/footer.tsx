   ...
   <footer className="bg-gray-900">
     <div className="max-w-7xl mx-auto px-4 w -full py-10 md:py-16">
        <div className="grid md:grid-cols-3 gap-7">
            <div>
                <Link href="/">
                <Image src="/beny.logo.png" alt="" width={128} height={49}/>
                </Link>
                <p className="text-gray-400">Pernah Ga Ready? Pernah</p>
            </div>
            <div>
            ...
            <div>
                ...
                <form action="" className="mt-5">
                    <div className="mb-5">
                        <input type="text" name="email" className="w-full p-3 rounded-sm bg-white" placeholder="gunadibeny@gmail.com"/>
                    </div>
     ...
     <div className="max-w-7xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        & Copyright 2025 | Beny Gunadi | All Right Reserved
      </div>
   </footer>
  )
}
